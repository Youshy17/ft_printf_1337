...
/*   Updated: 2024/12/02 16:27:58 by yel-hamr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	first_process(const char *format, int *flags, int *width_precision,
		char c)
{
	int	i;
...
static int	second_process(const char *format, int *flags, int *width_precision,
		char c)
{
	int	i;
